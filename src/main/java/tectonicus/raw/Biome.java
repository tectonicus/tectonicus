...
public enum Biome {
	...
	DESERT(2, 2.0f, 0.0f, WARM.getWaterColor()),
	...
	DESERT_HILLS(17, 2.0f, 0.0f, WARM.getWaterColor()),
	...
	STONE_SHORE(25, 0.2f, 0.3f, COLD.getWaterColor()),
	...
	SAVANNA(35, 1.2f, 0.0f, WARM.getWaterColor()),
	SAVANNA_PLATEAU(36, 1.0f, 0.0f, WARM.getWaterColor()),
	BADLANDS(37, 2.0f, 0.0f, WARM.getWaterColor()),
	WOODED_BADLANDS_PLATEAU(38, 2.0f, 0.0f, WARM.getWaterColor()),
	BADLANDS_PLATEAU(39, 2.0f, 0.0f, WARM.getWaterColor()),
	...
	DESERT_LAKES(130, 2.0f, 0.0f, WARM.getWaterColor()),
	...
	SHATTERED_SAVANNA(163, 1.1f, 0.0f, WARM.getWaterColor()),
	SHATTERED_SAVANNA_PLATEAU(164, 1.0f, 0.0f, WARM.getWaterColor()),
	ERODED_BADLANDS(165, 2.0f, 0.0f, WARM.getWaterColor()),
	MODIFIED_WOODED_BADLANDS_PLATEAU(166, 2.0f, 0.0f, WARM.getWaterColor()),
	MODIFIED_BADLANDS_PLATEAU(167, 2.0f, 0.0f, WARM.getWaterColor()),
