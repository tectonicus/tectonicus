	...
	public void addEdgeGeometry(int x, int y, int z, BlockContext world, BlockTypeRegistry registry, RawChunk rawChunk, Geometry geometry)
	{
		...
		for (PaintingEntity entity : rawChunk.getItemFrames())
		{
			...
			if (direction == 0) { // Facing down
				...
				Vector4f color = new Vector4f(topLight, topLight, topLight, 1);
				if (item.equals(FILLED_MAP))
				{
					BlockUtil.addBlock(mesh, x, y, z, 0, 15, 0, 16, 1, 16, color, border, topLight, northSouthLight, eastWestLight);
					MeshUtil.addQuad(mapMesh, new Vector3f(x, y+texel*14.99f, z+1f), new Vector3f(x+1f, y+texel*14.99f, z+1f),
							new Vector3f(x+1f, y+texel*14.99f, z), new Vector3f(x, y+texel*14.99f, z),  color, map);
				}
				else
				{
					BlockUtil.addBlock(mesh, x, y, z, 3, 15, 2, 10, 1, 1, color, border, topLight, northSouthLight, eastWestLight); // North
					BlockUtil.addBlock(mesh, x, y, z, 3, 15, 13, 10, 1, 1, color, border, topLight, northSouthLight, eastWestLight);  // South
					BlockUtil.addBlock(mesh, x, y, z, 2, 15, 2, 1, 1, 12, color, border, topLight, northSouthLight, eastWestLight);  // West
					BlockUtil.addBlock(mesh, x, y, z, 13, 15, 2, 1, 1, 12, color, border, topLight, northSouthLight, eastWestLight);  // East

					MeshUtil.addQuad(backgroundMesh, new Vector3f(x+texel*2.1f, y+texel*15.5f, z+texel*13.9f), new Vector3f(x+texel*13.9f, y+texel*15.5f, z+texel*13.9f),
							new Vector3f(x+texel*13.9f, y+texel*15.5f, z+texel*2.1f), new Vector3f(x+texel*2.1f, y+texel*15.5f, z+texel*2.1f), color, background);
				}
				...
				if (item.equals(FILLED_MAP))
				{
					BlockUtil.addBlock(mesh, x, y, z, 0, 0, 0, 16, 1, 16, color, border, topLight, northSouthLight, eastWestLight);
					MeshUtil.addQuad(mapMesh, new Vector3f(x, y+texel, z), new Vector3f(x+1f, y+texel, z),
							new Vector3f(x+1f, y+texel, z+1f), new Vector3f(x, y+texel, z+1f),  color, map);
				}
				else
				{
					BlockUtil.addBlock(mesh, x, y, z, 3, 0, 2, 10, 1, 1, color, border, topLight, northSouthLight, eastWestLight); // North
					BlockUtil.addBlock(mesh, x, y, z, 3, 0, 13, 10, 1, 1, color, border, topLight, northSouthLight, eastWestLight);  // South
					BlockUtil.addBlock(mesh, x, y, z, 2, 0, 2, 1, 1, 12, color, border, topLight, northSouthLight, eastWestLight);  // West
					BlockUtil.addBlock(mesh, x, y, z, 13, 0, 2, 1, 1, 12, color, border, topLight, northSouthLight, eastWestLight);  // East

					MeshUtil.addQuad(backgroundMesh, new Vector3f(x+texel*2.1f, y+texel*0.5f, z+texel*2.1f), new Vector3f(x+texel*13.9f, y+texel*0.5f, z+texel*2.1f),
							new Vector3f(x+texel*13.9f, y+texel*0.5f, z+texel*13.9f), new Vector3f(x+texel*2.1f, y+texel*0.5f, z+texel*13.9f),  color, background);
				}
